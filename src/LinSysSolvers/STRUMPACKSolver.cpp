...
void STRUMPACKSolver::innerSolve(Eigen::MatrixXd& rhs, Eigen::MatrixXd& result)
{
...
void STRUMPACKSolver::innerSolveRaw(const double* rhs_data, int rows, int cols, double* result_data)
{
